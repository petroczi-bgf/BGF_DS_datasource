...
As I mentioned you can use the diagram on http://chinookdatabase.codeplex.com/wikipage?title=Chinook_Schema&referringTitle=Home

In different files in First Assignments folder you'll find the questions and one of these files will be assigned to you.
There are 18 question, so 12 easier questions what are worth 1 point each and 6 difficult for 3 points each.
